      ...
      <body>
        <div className="bg-gray-200 min-h-[100dvh] grid grid-rows-[auto_1fr_auto]">             
          <div className="absolute z-0 inset-0 overflow-hidden">
            <div className="circle-one  w-64 h-64 rounded-full bg-rose-400/60 top-0 right-28 absolute"></div>
            <div className="circle-two  w-64 h-64 rounded-full bg-indigo-400/60 bottom-0 left-28 absolute"></div>
            </div>
          <header className="backdrop-blurbg-white/50 z-10">
            <div className="max-w-4xl mx-auto flex items-center justify-between">
              <h2 className="text-2xl text-gray-500 py-6">Next.js Strapi Project</h2>
             <nav>
