   ...
   return (
    <div>
      <div class="text-white relative bg-gray-700 px-14 py-16 -mx-8 -mt-7">
        ...
        <img className="object-cover absolute top-0 bottom-0 left-1/2 right-0 block w-1/2 h-full opacity-50 filter grayscale" src={`http://localhost:1337${member.photo.formats.medium.url}`}/>
         ...
         <div className="prose max-w-none"> {member.bodyContent.map((item, index) => OurRenderer(item, index))}
            </div>
             </div> 
         ) 
        }